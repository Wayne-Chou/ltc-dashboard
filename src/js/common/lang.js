...
export const LANG = {
  zh: {
    ...
    levelOverviewText:
      "顯示每位參與者的最新測驗結果，共 {people} 位參與者（{records} 筆測驗資料）。",
    levelSingleText: "{levelName}：共 {people} 位參與者（{records} 筆資料）。",
    overviewAllText:
      "顯示每位參與者的最新測驗結果，共 {people} 位參與者（{records} 筆測驗資料）。",
    overviewLevelText: "{level}：共 {people} 位參與者（{records} 筆資料）。",
    assessedCount: "鑑測人數",
    locations: {
      taipower: "台電據點",
      ntu: "台大據點",
  ...
  en: {
    ...
    levelOverviewText:
      "Showing the latest quiz results for each participant, total {people} participants ({records} quiz records).",
    levelSingleText:
      "{levelName}: Total {people} participants ({records} records).",
    overviewAllText:
      "Showing the latest quiz results for each participant, total {people} participants ({records} quiz records).",
    overviewLevelText:
      "{level}: Total {people} participants ({records} records).",
    ...
    selectedSitesLimit: "Selected Sites (Max 2)",
  ...
  ja: {
    ...
    levelOverviewText:
      "各参加者の最新のテスト結果を表示しています。合計 {people} 名の参加者（{records} 件のテストデータ）。",
    levelSingleText:
      "{levelName}：合計 {people} 名の参加者（{records} 件のデータ）。",
    overviewAllText:
      "各参加者の最新のテスト結果を表示しています。合計 {people} 名の参加者（{records} 件のテストデータ）。",
    overviewLevelText:
      "{level}：合計 {people} 名の参加者（{records} 件のデータ）。",
    assessedCount: "鑑測人数",
    locations: {
      taipower: "台電拠点",
      ntu: "台大拠点",
    ...
    unselectAll: "選択解除",
    groupCompare: "グループ比較",
    selectedSitesLimit: "選択済み拠点（最大2つ）",
  ...
  ko: {
    ...
    levelOverviewText:
      "각 참가자의 최신 테스트 결과를 표시합니다. 총 {people}명의 참가자 ({records}개의 테스트 데이터).",
    levelSingleText:
      "{levelName}: 총 {people}명의 참가자 ({records}개의 데이터).",
    overviewAllText:
      "각 참가자의 최신 테스트 결과를 표시합니다. 총 {people}명의 참가자 ({records}개의 테스트 데이터).",
    overviewLevelText:
      "{level}: 총 {people}명의 참가자 ({records}개의 데이터).",
